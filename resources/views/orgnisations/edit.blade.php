...
<div class="card">
    ...
    <div class="card-body">
        <div class="page-body">
            <div class="card">
                <div class="card-header card-info card-outline border-bottom"><h5></h5>
                            </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="line_of_buisness">
                                @if ($orgnisations->line_of_buisness_id)
                                <option value="{{ $orgnisations->line_of_buisness_id }}" selected {{ $orgnisations->line_of_buisness_id }}></option>
                                @else
